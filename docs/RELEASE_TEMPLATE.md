...
|---|---|---|
| Windows 10/11 | ✅ полноценно | loopback + вывод на N устройств |
| macOS 13+ | ⚠️ UI only | окно открывается, capture не работает |
| Linux (PipeWire) | ⚠️ UI only | окно открывается, capture не работает |

## Известные ограничения

- «Двоение» звука — by design loopback-подхода.
- Latency калибруется на слух.
- Тест-сигнал ещё не встроен.
